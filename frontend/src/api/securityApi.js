  ...
  sections: [
    {
      ...
      protectedCategories: [
        ...
        { name: "Legitimate Binaries Exploitation",   closed: 3,  open: 0 },
        { name: "Malicious Initial Access Attempts",  closed: 1,  open: 0 },
        { name: "Malicious Persistency Attempts",     closed: 0,  open: 0 },
        { name: "Privilege Escalation Attempts",      closed: 0,  open: 0 },
        { name: "Malicious Evasion Attempts",         closed: 2,  open: 0 },
        { name: "Credentials Theft Attempts",         closed: 0,  open: 0 },
      ],
      alertsOverTime: [
        { label: "Jan 10", value: 2  },
        { label: "Feb 21", value: 11 },
        { label: "Mar 15", value: 1  },
        { label: "Mar 28", value: 4  },
        { label: "Today",  value: 1  },
      ],
      risksOverTime: [
        { label: "Mar 06", value: 45  },
        { label: "Mar 13", value: 85  },
        { label: "Mar 20", value: 128 },
        { label: "Mar 27", value: 43  },
        { label: "Apr 03", value: 97  },
      ],
      devices: [
        { id: 1,  name: "WINS102",                    ip: "10.1.3.20",      os: "windows", group: "Emir Testing WIN",      lastSeen: "just now", status: "ok"       },
        { id: 2,  name: "Administrator's MacBook Air", ip: "192.168.100.40", os: "mac",     group: "Adeline_Endpoint_MAC", lastSeen: "25 min",   status: "ok"       },
        { id: 3,  name: "Stanislav's MacBook Pro",     ip: "10.4.0.39",      os: "mac",     group: "Adeline_Endpoint_MAC", lastSeen: "1 hr",     status: "ok"       },
        { id: 4,  name: "adelinelp's MacBook Air",     ip: "192.168.1.203",  os: "mac",     group: "Adeline_Endpoint_MAC", lastSeen: "1 hr",     status: "ok"       },
        { id: 5,  name: "DESKTOP-PBT0052",             ip: "172.20.10.2",    os: "windows", group: "Adeline_Endpoint_WIN", lastSeen: "2 hr",     status: "ok"       },
        { id: 6,  name: "Adeline's MacBook Air",       ip: "192.168.8.45",   os: "mac",     group: "Adeline_Endpoint_MAC", lastSeen: "4 hr",     status: "ok"       },
        { id: 7,  name: "buh2",                        ip: "10.1.2.14",      os: "windows", group: "Adeline_Endpoint_WIN", lastSeen: "7 hr",     status: "ok"       },
        { id: 8,  name: "buh2",                        ip: "10.1.2.101",     os: "windows", group: "Adeline_Endpoint_WIN", lastSeen: "9 hr",     status: "ok"       },
        { id: 9,  name: "MacBook Air — Adeline",       ip: "11.0.1.150",     os: "mac",     group: "Adeline_Endpoint_MAC", lastSeen: "1 day",    status: "ok"       },
        { id: 10, name: "Apple's MacBook Pro",         ip: "172.20.10.5",    os: "mac",     group: "Adeline_Endpoint_MAC", lastSeen: "2 days",   status: "ok"       },
        { id: 11, name: "Adeline's MacBook Air",       ip: "10.1.2.24",      os: "mac",     group: "Adeline_Endpoint_MAC", lastSeen: "6 days",   status: "ok"       },
        { id: 12, name: "DESKTOP-A1B2C",               ip: "10.0.1.5",       os: "windows", group: "Adeline_Endpoint_WIN", lastSeen: "3 days",   status: "inactive" },
        { id: 13, name: "LAPTOP-X9Y8Z",                ip: "10.0.2.8",       os: "windows", group: "Adeline_Endpoint_WIN", lastSeen: "5 days",   status: "inactive" },
      ],
    },
    {
      id: "users",
